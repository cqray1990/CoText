...
from infer_img_atten import PANppE2E
...
if __name__ == '__main__':
    ...
    config_path = './config/pan_pp/pan_pp_r18_atten_ic15_desc.py'
    checkpoint_path = './outputs/pan_pp_r18_atten_ic15_desc/50_0_0_0_0_checkpoint.pth.tar'# 3_162_0_0_0_checkpoint.pth.tar' 
...
#     data_root = "/share/wuweijia/MyBenchMark/MMVText/BOVTextV2/Test/Frames"
    ...
    pANppE2E = PANppE2E(checkpoint_path, config_path, ctc=False)
