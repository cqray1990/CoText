...
class PAN_IC15_video(data.Dataset):
    def __init__(self,
        ...
        self.img_paths['ic15'] = self.img_paths['ic15'] * 50
        self.gts['ic15'] = self.gts['ic15'] * 50 #5
...
#         print(img_names)
        ...
        self.img_paths['ic15_video'] = self.img_paths['ic15_video'] * 50
        self.gts['ic15_video'] = self.gts['ic15_video'] * 50 #3
