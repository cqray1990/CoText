...
ic15_train_data_dir = '/mmu-ocr/weijiawu/Data/ICDAR2015/train_image/'
ic15_train_gt_dir = '/mmu-ocr/weijiawu/Data/ICDAR2015/train_gt/'

coco_root_dir = '/mmu-ocr/weijiawu/Data/COCOTextV2/'
coco_train_data_dir = coco_root_dir + 'train_image/'
coco_train_gt_dir = coco_root_dir + 'train_gt_icd15/'

synth_root_dir = '/mmu-ocr/weijiawu/Data/SynthText/'
synth_train_data_dir = synth_root_dir
synth_train_gt_dir = synth_root_dir + 'gt.mat'


# synth_root_dir = '/mmu-ocr/yuzhong/code/VideoSynthtext/SynthText/gen_data/synthtextvid'
# synth_train_data_dir = synth_root_dir
# synth_train_gt_dir = synth_root_dir + 'gt.mat'

ic15_video_train_data_dir = '/mmu-ocr/weijiawu/Data/ICDAR2015_video/icd15/train_image' #home/wangjue_Cloud
ic15_video_train_gt_dir = '/mmu-ocr/weijiawu/Data/ICDAR2015_video/icd15/train_gt'   # home/wangjue_Cloud
...
class CoText_IC15_video(data.Dataset):
    def __init__(self,
                 split='train',
                 is_transform=False,
                 img_size=None,
...
#         self.gts['synthtext'] = []
#         for video_ in os.listdir(synth_root_dir):
#             ann_path = os.path.join(synth_root_dir,video_,"ann.json")
#             if os.path.isfile(ann_path):
# #                 data = scio.loadmat(ann_path)
...
#                     roo_image_path = os.path.join(synth_root_dir,img_paths.replace("gen_data/synthtextvid/",""))
...
#         print(len(self.img_paths['synthtext']))
        ...
        self.img_paths['ic15'] = self.img_paths['ic15']
        self.gts['ic15'] = self.gts['ic15'] #5
        ...
        self.img_paths['cocotext'] = self.img_paths['cocotext'] 
        self.gts['cocotext'] = self.gts['cocotext'] 
...
#         self.img_paths['ic15_video'] = self.img_paths['ic15_video'] * 20
#         self.gts['ic15_video'] = self.gts['ic15_video'] * 20 #3
...
if __name__=='__main__':
    import sys
    sys.path.append('/mmu-ocr/weijiawu/Code/VideoSpotting/PAN_VTS/CoText')
    from utils import visulization

    data_loader = CoText_IC15_video(
        split='train',
        is_transform=True,
        img_size=736,
        short_size=736,
